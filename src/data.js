...
export const PRODUCTS = [
  ...
  { id: 7, name: "Floating Shelf Bracket", price: 28.99, tag: "NEW", category: "Home Decor", time: "3h 10m", desc: "Minimal cantilever shelf support. Matte PETG, load-bearing 5kg.", accent: "#0ABFBC", bg: "#E6FFFE", img: ["🏠","🔌","📱", "🪪", "🌿","🗂️"], model: "/3d/Rose/files/Rose.stl" },
  ...
  { id: 9, name: "Cable Management Hub", price: 22.99, tag: "", category: "Office", time: "2h 45m", desc: "Route up to 8 cables cleanly. Tool-free snap fit design.", accent: "#FF9F43", bg: "#FFF4E6", img: ["🔌"], model: "/3d/Rose/files/Rose.stl" },
  ...
  { id: 11, name: "Custom Nameplate", price: 16.99, tag: "", category: "Gifts", time: "2h 00m", desc: "Personalised with any name or message. 15 filament colours available.", accent: "#E84393", bg: "#FFF0F7", img: ["🪪"], model: "/3d/Rose/files/Rose.stl" },
  ...
  { id: 13, name: "Floating Shelf Bracket", price: 28.99, tag: "NEW", category: "Home Decor", time: "3h 10m", desc: "Minimal cantilever shelf support. Matte PETG, load-bearing 5kg.", accent: "#0ABFBC", bg: "#E6FFFE", img: ["🏠","🔌","📱", "🪪", "🌿","🗂️"], model: "/3d/Rose/files/Rose.stl" }, 
